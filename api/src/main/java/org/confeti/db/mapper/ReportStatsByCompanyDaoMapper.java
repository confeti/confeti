...
import static org.confeti.db.model.ReportStatsByCompanyEntity.REPORT_STATS_BY_COMPANY_ATT_COMPANY_NAME;
import static org.confeti.db.model.ReportStatsByCompanyEntity.REPORT_STATS_BY_COMPANY_ATT_REPORT_TOTAL;
import static org.confeti.db.model.ReportStatsByCompanyEntity.REPORT_STATS_BY_COMPANY_ATT_YEAR;
import static org.confeti.db.model.ReportStatsByCompanyEntity.REPORT_STATS_BY_COMPANY_TABLE;
...
public interface ReportStatsByCompanyDaoMapper extends BaseMapper {
    ...
    default void createSchema(@NotNull final CqlSession cqlSession) {
        cqlSession.execute(createTable(REPORT_STATS_BY_COMPANY_TABLE).ifNotExists()
                ...
                .withColumn(REPORT_STATS_BY_COMPANY_ATT_REPORT_TOTAL, DataTypes.COUNTER)
